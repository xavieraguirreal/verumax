...
return [
    // Meta SEO
    'meta_title' => 'Fabricatum - Desenvolvimento de Software Sob Medida | Web, Mobile, Desktop',
    'meta_description' => 'Desenvolvimento de software sob medida: sites, aplicativos móveis, software desktop para Windows e Linux. Programamos do zero, sem limites.',
    'meta_keywords' => 'desenvolvimento software, aplicativos móveis, software desktop, Windows, Linux, desenvolvimento web, PHP, Python, C#, programação sob medida',
    'meta_og_title' => 'Fabricatum - Desenvolvimento de Software Sob Medida | Verumax',
    'meta_og_description' => 'Programamos do zero. Web, Mobile, Desktop. Sem templates. Sem limites.',
    ...
    'problema_card3_icon' => '🔗',
    'problema_card3_title' => 'Integrações Complexas',
    'problema_card3_desc' => 'Conectar múltiplos sistemas, hardware especializado, APIs próprias. Tudo funcionando como um só.',

    'problema_card4_icon' => '📈',
    'problema_card4_title' => 'Escalabilidade Sem Teto',
    'problema_card4_desc' => 'Seu projeto cresce sem limites de licenças. Evolua seu software no ritmo do seu negócio.',
    ...
    'solucion_card3_title' => 'Integração Total',
    'solucion_card3_desc' => 'Conectamos tudo: bancos de dados, APIs, hardware, serviços externos. Um ecossistema que funciona como um só.',
    ...
    'nosotros_subtitle' => 'Código profundo + Inteligência Artificial com olhar humano',

    'nosotros_intro' => 'Combinamos duas fortalezas únicas: <strong>expertise em programação de baixo nível</strong> (nascemos com a linguagem C, entendemos as máquinas por dentro) e <strong>especialização em Inteligência Artificial Social</strong> (aplicamos IA com olhar humano desde 1997). Essa combinação nos permite criar software que não só funciona, mas que <strong>potencializa as pessoas</strong>.',

    'nosotros_historia_title' => 'Nossa História',
    'nosotros_historia_desc' => 'Desde a <strong>década de 90</strong>, nos dedicamos a <strong>formar programadores/as e designers web</strong>. Durante mais de duas décadas, capacitamos centenas de profissionais. Agora, aplicamos toda essa experiência no que fazemos de melhor: <strong>programar e desenvolver software</strong>.',

    'nosotros_codigo_title' => 'Expertise em Código',
    'nosotros_codigo_desc' => 'Nascemos com a <strong>linguagem C</strong>, uma das mais próximas da máquina. Entendemos o que acontece dentro do gabinete: como os processos se comunicam, como os dados fluem, como otimizar cada ciclo. <strong>Não só programamos, entendemos as máquinas.</strong>',

    'nosotros_ia_title' => 'IA com Olhar Humano',
    'nosotros_ia_desc' => 'Desde <strong>1997</strong>, impulsionamos a <strong>Inteligência Artificial Social</strong> na <strong>Michigan State University</strong>. Não usamos IA para substituir pessoas, mas para <strong>potencializá-las</strong>. Integramos IA em nossos desenvolvimentos para melhorar experiências, automatizar o repetitivo e liberar o potencial humano.',

    'nosotros_formacion_title' => 'Formação Acadêmica',
    'nosotros_formacion_desc' => 'Formados na <strong>Universidad Nacional de La Plata</strong> e na <strong>Universidad Tecnológica Nacional</strong>. Conhecimentos sólidos em ciências da computação.',

    'nosotros_filosofia_title' => 'Nossa Filosofia',
    'nosotros_filosofia_desc' => 'Não somos uma agência que instala templates. Somos <strong>programadores/as de verdade</strong> que entendem cada linha de código que escrevem. E somos <strong>especialistas em IA Social</strong> que sabem como aplicar inteligência artificial para melhorar a vida das pessoas.',
    ...
    'cms_card2_desc' => 'Potente e flexível. Ideal para sites corporativos, portais e comunidades. Extensões personalizadas.',
    ...
    'servicios_subtitle' => 'Desenvolvimento integral para todas as plataformas',
    ...
    'comp_header_propio' => 'Código Próprio',

    'comp_row1_aspecto' => 'Ideal para',
    'comp_row1_cms' => 'Sites padrão, blogs, lojas simples',
    'comp_row1_propio' => 'Projetos únicos, sistemas complexos',

    'comp_row2_aspecto' => 'Tempo de desenvolvimento',
    'comp_row2_cms' => 'Rápido (dias a semanas)',
    'comp_row2_propio' => 'Variável conforme complexidade',

    'comp_row3_aspecto' => 'Personalização',
    'comp_row3_cms' => 'Limitada a plugins/themes',
    'comp_row3_propio' => 'Ilimitada, 100% sob medida',
    ...
    'comp_row5_propio' => 'Sem limites',

    'comp_row6_aspecto' => 'Investimento inicial',
    'comp_row6_cms' => 'Menor',
    'comp_row6_propio' => 'Maior, mas sem custos recorrentes',

    // Processo
    'proceso_title' => 'Nosso Processo',
    ...
    'tech_subtitle' => 'Dominamos todas as plataformas',

    'tech_backend' => 'Backend',
    'tech_frontend' => 'Frontend',
    'tech_mobile' => 'Mobile',
    'tech_desktop' => 'Desktop',
    'tech_database' => 'Bancos de Dados',
    ...
    // Contato
    'contacto_title' => 'Vamos Falar do Seu Projeto',
    'contacto_subtitle' => 'Preencha o formulário e entramos em contato em 24h',
    'contacto_nombre' => 'Nome',
    'contacto_email' => 'Email',
    'contacto_telefono' => 'Telefone',
    'contacto_empresa' => 'Empresa / Projeto',
    'contacto_tipo' => 'Tipo de Projeto',
    'contacto_tipo_web' => 'Site',
    'contacto_tipo_ecommerce' => 'E-Commerce',
    'contacto_tipo_webapp' => 'Aplicação Web / SaaS',
    'contacto_tipo_mobile' => 'App Móvel (Android/iOS)',
    'contacto_tipo_desktop' => 'Software Desktop',
    ...
    // Footer
    'footer_slogan' => 'Programamos do zero. Sem limites.',
    'footer_copy' => '© 2026 Verumax. Todos os direitos reservados.',
    'footer_links_title' => 'Soluções',
    'footer_contacto_title' => 'Contato',
    ...
    // Misc
    'volver_verumax' => '← Voltar para Verumax',
    'ver_mas' => 'Ver mais',
];
