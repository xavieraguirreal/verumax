<?php
/**
 * OriginalisDoc - Tarjeta Digital Profesional
...
<body class="bg-black text-white">
    ...
    <section id="planes" class="py-20 bg-gray-950">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-400"><?php echo $lang['prof_planes_subtitulo']; ?></p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                ...
                <div class="bg-gray-900 border border-gold/20 rounded-xl p-6 flex flex-col">
                    ...
                    <p class="text-3xl font-bold text-white mb-4">
                        <?php echo $lang['prof_plan_esencial_precio']; ?>
                        <span class="text-sm font-normal text-gray-400"><?php echo $lang['prof_plan_esencial_periodo']; ?></span>
                    </p>
                ...
                <div class="bg-gray-900 border-2 border-gold rounded-xl p-6 flex flex-col relative">
                    ...
                    <p class="text-3xl font-bold text-white mb-4">
                        <?php echo $lang['prof_plan_plus_precio']; ?>
                        <span class="text-sm font-normal text-gray-400"><?php echo $lang['prof_plan_plus_periodo']; ?></span>
                    </p>
                    <ul class="space-y-2 mb-6 text-gray-300 text-xs flex-grow">
                        <li class="flex items-start gap-1.5">
                ...
                <div class="bg-gray-900 border border-gold/20 rounded-xl p-6 flex flex-col">
                    ...
                    <p class="text-3xl font-bold text-white mb-4">
                        <?php echo $lang['prof_plan_pro_precio']; ?>
                        <span class="text-sm font-normal text-gray-400"><?php echo $lang['prof_plan_pro_periodo']; ?></span>
                    </p>
                    <ul class="space-y-2 mb-6 text-gray-300 text-xs flex-grow">
                        <li class="flex items-start gap-1.5">
                            <svg class="w-4 h-4 text-metallic-green-light flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gray-900 border border-gold/20 rounded-xl p-6 flex flex-col">
                    ...
                    <p class="text-3xl font-bold text-white mb-4">
                        <?php echo $lang['prof_plan_elite_precio']; ?>
                        <span class="text-sm font-normal text-gray-400"><?php echo $lang['prof_plan_elite_periodo']; ?></span>
                    </p>
                    <ul class="space-y-2 mb-6 text-gray-300 text-xs flex-grow">
                        <li class="flex items-start gap-1.5">
                            <svg class="w-4 h-4 text-metallic-green-light flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Footer Simple -->
    <footer class="bg-black border-t border-gold/20 py-8">
        <div class="container mx-auto px-6">
            <div class="text-center text-gray-400 text-sm">
                <p>&copy; 2025 OriginalisDoc. <?php echo $lang['footer_copyright']; ?></p>
            </div>
        </div>
    </footer>

    <!-- Botón Scroll to Top -->
    <button id="scrollToTop" class="fixed bottom-8 right-8 w-12 h-12 bg-gold hover:bg-gold-light text-black rounded-full shadow-lg hover:shadow-xl transition-all duration-300 opacity-0 pointer-events-none z-50">
