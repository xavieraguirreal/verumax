...
$search = "// Obtener branding de la configuración (con fallback a archivos locales)
\$logo_url = null;
\$logo_2_url = null;
...
$replace = "// Obtener branding de la configuración
...
if (strpos($content, $search) !== false) {
    ...
    echo "Revertido a codigo original\n";
} else {
